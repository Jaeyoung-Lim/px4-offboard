...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        self.takeoff_height = -self.get_parameter('altitude').get_parameter_value().double_value
    ...
    def timer_callback(self) -> None:
        ...
        if self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD:
            if self.vehicle_local_position.z > self.takeoff_height:
                ...
                x = self.radius * np.cos(self.omega * elapsed)
                y = self.radius * np.sin(self.omega * elapsed)
